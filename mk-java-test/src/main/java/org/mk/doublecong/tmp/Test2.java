...
public class Test2 {
    public final static Logger log = LoggerFactory.getLogger(Test2.class);
...
//加密前：randomStr502doublecong
//加密后：
//07998a7a8f8d966e8d804c434390769984948c6a758093
//解密：
//randomStr502doublecong
//        for (int i = 0; i < 32; i++) {
//            btmp[i] = (byte) (Math.random()*30);
//            System.out.println( btmp[i]+" ===: ");
//        }
        System.out.println("加密前：randomStr502doublecong");
        String str = Test2.getencrystr(Test2.getencrystr("randomStr502doublecong"));
        System.out.println("\n加密后：");
        System.out.println(str);

        System.out.println("解密：");
        System.out.println(Test2.getunencrystr(Test2.getunencrystr(str)));
    }
     ...
     * @return 加密后的字符串
     */
    public static String getencrystr(String s) {
        if (s.length() == 0)
            return "";
        try {
            int sum = 0;
     ...
     * @return 解密后的字符串
     */
    public static String getunencrystr(String s) {
        String s1, s2, s3 = "";
        // 1组32个随机数
